...
<div class="w-full md:w-1/4 p-2 m-3 border bg-white">
  <div class="flex-col">
    <!-- Profile Card -->
    <a href="{base}/feedback/${feedback.id}">
      <div
  ...
  background-blend-mode: multiply;"
      >
        ...
        <div class="w-full flex relative px-3">
          <div class="w-1/4 md:w-1/10 justify-start">
            <img
        ...
        <div class="w-full flex text-right px-3">
          <span
            class={`flex-1 text-green-400 ${
              feedback.reviewed ? "" : "invisible"
            }`}>Verified</span
          >
        </div>
      </div>
